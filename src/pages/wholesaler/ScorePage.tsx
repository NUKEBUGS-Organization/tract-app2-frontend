  ...
  return (
    <div className="flex min-h-screen bg-tract-alabaster font-inter">
      ...
      <main className="ml-[240px] flex-1 p-8 md:p-12">
        <h1 className="mb-8 font-playfair text-[28px] font-bold text-tract-obsidian">Reliability Score</h1>
        ...
        {isLoading ? (
          ...
          <div className="space-y-8">
            <div className="rounded-[12px] border border-gray-100 bg-white p-8 text-center shadow-sm">
              <p className="mb-4 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-400">
                Current Score
              </p>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 border-t border-gray-100 pt-6">
                ...
                <div>
                  <p className="font-inter text-[10px] font-bold uppercase text-gray-400">Restrictions</p>
                  <p className="mt-1 font-playfair text-[24px] font-bold text-tract-obsidian">
                    {score < 50 ? 'Yes' : 'None'}
                  </p>
                </div>
                <div>
                  <p className="font-inter text-[10px] font-bold uppercase text-gray-400">Status</p>
            ...
            {score < 70 && score >= 30 ? (
              <div className="flex items-start gap-4 rounded-[12px] border border-orange-200 bg-orange-50 p-6">
                ...
                <div>
                  <p className="font-inter font-bold text-tract-obsidian">Score Warning</p>
                  <p className="mt-1 font-inter text-[14px] text-gray-600">
                    {score < 50
            ...
            <div className="overflow-hidden rounded-[12px] border border-gray-100 bg-white shadow-sm">
              <div className="border-b border-gray-100 px-8 py-6">
                <h2 className="font-playfair text-[20px] font-bold text-tract-obsidian">Score History</h2>
              </div>
              {penalties.length === 0 ? (
                <div className="px-8 py-12 text-center">
                  <CheckCircle2 className="mx-auto mb-3 h-10 w-10 text-tract-green" />
                  <p className="font-inter text-gray-500">No penalties on record. Keep it up!</p>
                </div>
              ) : (
                  ...
                  {penalties.map((p) => (
                    <div key={p._id} className="flex items-start justify-between gap-4 px-8 py-5">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="font-inter text-[14px] font-bold text-tract-obsidian">
            ...
            <div className="rounded-[12px] border border-gray-100 bg-white p-8 shadow-sm">
              <h2 className="mb-6 font-playfair text-[20px] font-bold text-tract-obsidian">How Scoring Works</h2>
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span className="font-inter text-[14px] text-gray-600">{rule.label}</span>
                    <span
