              ...
              <div className="mb-1 flex items-center gap-1">
                ...
                <span
                  className={cn(
                    ...
                    done && (isLight ? 'text-gray-500' : 'text-gray-400'),
                    active && 'text-tract-gold',
                    !done && !active && (isLight ? 'text-gray-400 opacity-80' : 'text-gray-500 opacity-50'),
                  )}
                >
                  {s.barLabel}
                </span>
  ...
  return (
    <div className="mb-10 w-full">
      <div className="mb-2 flex items-center justify-between">
        <span className="font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">
...
function CreateListingStickyBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-gray-200 bg-white shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between md:px-12">
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          <span className="font-inter text-sm font-semibold text-tract-obsidian">{stepsCompleteLabel}</span>
        ...
        <div className="flex gap-3">
          <button
            type="button"
            onClick={onBack}
            className="flex items-center gap-1 rounded-lg px-6 py-3 font-inter text-sm font-semibold text-tract-obsidian transition-colors hover:bg-gray-100"
          >
    ...
    <div className="flex min-h-screen bg-tract-alabaster font-inter text-tract-obsidian">
      ...
      <div className="ml-[240px] flex min-h-screen min-w-0 flex-1 flex-col">
        ...
        >
          ...
          {step === 'arv' ? (
            <>
              <h1 className="mb-6 font-playfair text-[28px] font-bold text-tract-obsidian">Property Valuation</h1>
              ...
              <section className="mb-6 rounded-xl border border-[#323538]/40 bg-white p-6 shadow-sm transition-all duration-300 hover:border-tract-gold md:p-8">
                <div className="mb-6 flex flex-col justify-between gap-6 md:flex-row md:items-end">
                  <div className="min-w-0 flex-1">
                    <label htmlFor="arv-input" className="mb-2 block font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">
                    ...
                    <div className="flex items-baseline border-b-2 border-tract-gold pb-1">
                      <span className="shrink-0 font-playfair text-[40px] font-bold text-tract-obsidian">$</span>
                      <input
                        id="arv-input"
                        inputMode="numeric"
                        autoComplete="off"
                        ...
                        className="min-w-0 flex-1 border-0 bg-transparent p-0 font-playfair text-[40px] font-bold text-tract-obsidian placeholder:text-gray-300 focus:outline-none focus:ring-0"
                      />
                    </div>
                    {arvError ? (
                ...
                >
                  ...
                  <h4 className="font-inter text-lg font-semibold text-tract-obsidian">
              ...
              <section className="mb-6 rounded-xl border border-[#323538]/40 bg-white p-6 shadow-sm transition-all duration-300 hover:border-tract-gold md:p-8">
                <h3 className="mb-6 font-playfair text-[20px] font-bold text-tract-obsidian">Rehab Cost Estimate</h3>
                <div className="mb-6 overflow-hidden">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="py-4 text-left font-inter text-[12px] font-bold uppercase tracking-wider text-gray-500">
                          Item
                        </th>
                        <th className="py-4 text-right font-inter text-[12px] font-bold uppercase tracking-wider text-gray-500">
                          Estimated cost
                        </th>
                      </tr>
                    </thead>
                    <tbody className="font-inter text-base text-tract-obsidian">
                      {rehabRows.map((row) => (
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    <span className="font-inter text-base font-bold text-tract-obsidian">Total rehab cost:</span>
                    <span className="font-playfair text-[24px] font-bold text-tract-obsidian">{formatCurrency(rehabTotal)}</span>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 border-t border-gray-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                <button
                  ...
                  className="flex items-center gap-1 font-inter text-sm font-semibold text-gray-500 transition-colors hover:text-tract-obsidian disabled:opacity-50"
                >
          ...
          {step === 'deal' ? (
            <>
              ...
              <section className="mb-6 rounded-xl border border-white/10 bg-[#191C1F] p-6 md:p-8">
                <p className="mb-6 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-400">
                  Select deal type
                </p>
                  ...
                  {DEAL_TYPES.map(({ id, label, Icon }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <Icon
                            className={cn('h-5 w-5', selected ? 'text-tract-gold' : 'text-gray-400')}
                            strokeWidth={2}
                            aria-hidden
                          />
                        </div>
              ...
              <section className="mb-6">
                <p className="mb-3 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-400">
                  Market status
                </p>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      marketStatus === 'off_market'
                        ? 'bg-gray-100 text-tract-obsidian'
                        : 'border border-[#323538] bg-[#191C1F] text-gray-400 hover:bg-[#272A2E]',
                    )}
                  >
                    Off-Market
                  </button>
              ...
              <div className="flex flex-col gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
                <button
                  ...
                  className="flex items-center gap-1 font-inter text-sm font-semibold text-gray-400 transition-colors hover:text-gray-100"
                >
                  <ArrowLeft className="h-4 w-4" strokeWidth={2} aria-hidden />
                  Back
                </button>
          ...
          {step === 'media' ? (
            <>
              <h1 className="mb-10 font-playfair text-[32px] font-bold leading-tight text-tract-obsidian">Media &amp; Documents</h1>

              <section className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-tract-gold md:p-8">
                <h2 className="mb-6 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">Property photos</h2>
                <input
                ...
                <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                  ...
                  {vaultPhotos.length < MAX_VAULT_PHOTOS ? (
                    ...
                    >
                      ...
                      <span className="font-inter text-[12px] font-bold uppercase tracking-wider text-gray-500">Add photo</span>
                    </button>
                  ) : null}
                </div>
                <p className="font-inter text-sm text-gray-500">Upload up to 20 photos (JPG, PNG or WEBP)</p>
              </section>

              <section className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-tract-gold md:p-8">
                <h2 className="mb-6 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">Video walkthrough</h2>
                <input
                ...
                <button
                  ...
                  className="mb-6 flex h-[min(400px,55vh)] w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-[#4d4635]/40 bg-[#F9FAFB] transition-colors hover:border-tract-gold hover:bg-gray-50"
                >
                  <Video className="mb-4 h-14 w-14 text-tract-gold" strokeWidth={1.25} aria-hidden />
                  <p className="mb-1 font-inter text-base font-semibold text-tract-obsidian">Upload walkthrough video</p>
                  <p className="font-inter text-sm text-gray-500">MP4 up to 500MB • Recommended 1080p</p>
                  {videoDraftName ? (
                    <p className="mt-3 font-inter text-sm text-tract-green">Selected: {videoDraftName}</p>
                  ) : null}
                </button>
                <div className="flex flex-col gap-1">
                  <label htmlFor="video-link" className="font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">
                    Or paste a link
                  </label>
                  <input
                    id="video-link"
                    ...
                    className="w-full border-0 border-b border-gray-300 bg-[#F9FAFB] py-3 font-inter text-base text-tract-obsidian placeholder:text-gray-400 focus:border-tract-gold focus:outline-none focus:ring-0"
                  />
                </div>
              </section>

              <section className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-tract-gold md:p-8">
                <h2 className="mb-6 font-inter text-[12px] font-bold uppercase tracking-widest text-gray-500">Seller disclosures</h2>
                <input
                ...
                <div className="mb-8 flex flex-col gap-4">
                  {disclosures.map((d) => (
                    <div
                      key={d.id}
                      className="flex items-center justify-between rounded-lg border border-gray-200 bg-[#F9FAFB] p-4"
                    >
                      <div className="flex min-w-0 items-center gap-3">
                        <FileText className="h-6 w-6 shrink-0 text-gray-500" strokeWidth={1.75} aria-hidden />
                        <span className="truncate font-inter text-base font-semibold text-tract-obsidian">{d.name}</span>
                      </div>
                      {d.verified ? (
                ...
                >
                  <Upload className="h-6 w-6 text-gray-500" strokeWidth={1.75} aria-hidden />
                  <span className="font-inter text-base font-semibold text-gray-600">Upload additional disclosures</span>
                </button>
              </section>
            </>
          ) : null}
          ...
          {step === 'review' ? (
            <>
              <button
                ...
                className="mb-6 flex items-center gap-2 font-inter text-sm font-semibold text-gray-500 transition-colors hover:text-tract-obsidian"
              >
                <ArrowLeft className="h-4 w-4" strokeWidth={2} aria-hidden />
                Back to media vault
              </button>
              ...
              <div className="mb-10">
                <h1 className="mb-1 font-playfair text-[24px] font-bold text-tract-obsidian">Review your listing</h1>
                <p className="font-inter text-base text-gray-500">This is exactly how your listing will appear to verified buyers.</p>
              </div>

              <div className="mb-6 overflow-hidden rounded-xl border border-gray-200/80 bg-white shadow-md transition-transform duration-300 hover:scale-[1.01]">
                ...
                <div className="space-y-4 p-6">
                  ...
                  <div className="flex flex-wrap gap-8 border-y border-gray-100 py-4">
                    <div className="flex flex-col gap-0.5">
                      <span className="font-inter text-[10px] font-bold uppercase tracking-wider text-gray-500">ARV</span>
                      <span className="font-inter text-sm font-semibold tracking-wide text-tract-obsidian">{formatCurrency(arv)}</span>
                    </div>
                    <div className="flex flex-col gap-0.5">
                      <span className="font-inter text-[10px] font-bold uppercase tracking-wider text-gray-500">Rehab</span>
                      <span className="font-inter text-sm font-semibold tracking-wide text-tract-obsidian">
                        {formatCurrency(rehabTotal)}
                      </span>
                    </div>
                    <div className="flex flex-col gap-0.5">
                      <span className="font-inter text-[10px] font-bold uppercase tracking-wider text-gray-500">Fee</span>
                      <span className="font-inter text-sm font-semibold tracking-wide text-tract-obsidian">
              ...
              <div className="mb-6 space-y-4 rounded-xl border border-gray-200/80 bg-white p-6 shadow-sm md:p-8">
                {(
                  [
                  ...
                  <div
                    key={label}
                    className="grid grid-cols-2 gap-y-1 border-b border-gray-100 pb-4 last:border-0 last:pb-0"
                  >
                    <div className="font-inter text-sm text-gray-500">{label}</div>
                    <div
                      className={cn(
                        'text-right font-inter text-base font-bold text-tract-obsidian',
                ...
                <div className="grid grid-cols-2 gap-y-1 border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                  ...
                  <div className="flex items-center justify-end gap-2">
                    {showPrivateFee && hasPrivateFee ? (
                      ...
                      <span className="font-inter text-base font-bold tracking-[0.35em] text-tract-obsidian">••••••</span>
                    )}
                    <button
                      type="button"
                      onClick={() => setShowPrivateFee((v) => !v)}
                      className="rounded p-1 text-gray-500 transition-colors hover:text-tract-gold"
              ...
              <div className="space-y-4 pb-4">
                ...
                <div className="text-center">
                  <button
                    ...
                    disabled={createMutation.isPending || updateMutation.isPending}
                    onClick={() => void saveDraft()}
                    className="font-inter text-sm text-gray-500 underline decoration-1 underline-offset-4 transition-colors hover:text-tract-obsidian disabled:opacity-50"
                  >
